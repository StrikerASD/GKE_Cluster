module "gke_state_bucket" {
  ...
  google_kms_crypto_key_name = "gke-crypto-key"
  google_kms_key_ring_project = "sb-izal-20240703-111957"
  google_kms_crypto_key_iam_member_crypto_key_id = "projects/sb-izal-20240703-111957/locations/europe-west3/keyRings/gke-keyring/gke-cr"
