module "gke_state_bucket" {
  ...
  google_kms_crypto_key_iam_member_crypto_key_id = "projects/sb-izal-20240703-111957/locations/europe-west3/keyRings/gke-keyring/gke-crypto"
  ...
  google_storage_bucket_encryption_default_kms_key_name = "projects/sb-izal-20240703-111957/locations/europe-west3/keyRings/gke-keyring/cryptoKeys/gke-crypto"
}
